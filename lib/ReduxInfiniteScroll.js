...
ReduxInfiniteScroll.propTypes = {
  elementIsScrollable: _react["default"].PropTypes.bool,
  containerHeight: _react["default"].PropTypes.oneOfType([_react["default"].PropTypes.number, _react["default"].PropTypes.string]),
  threshold: _react["default"].PropTypes.number,
  horizontal: _react["default"].PropTypes.bool,
  hasMore: _react["default"].PropTypes.bool,
  loadingMore: _react["default"].PropTypes.bool,
  loader: _react["default"].PropTypes.any,
  showLoader: _react["default"].PropTypes.bool,
  loadMore: _react["default"].PropTypes.func.isRequired,
  items: _react["default"].PropTypes.oneOfType([//ImmutablePropTypes.list,
  _react["default"].PropTypes.array]),
  children: _react["default"].PropTypes.oneOfType([//ImmutablePropTypes.list,
  _react["default"].PropTypes.array]),
  holderType: _react["default"].PropTypes.string,
  className: _react["default"].PropTypes.oneOfType([_react["default"].PropTypes.string, _react["default"].PropTypes.func]),
  animateItems: _react["default"].PropTypes.bool,
  transitionName: _react["default"].PropTypes.string,
  transitionEnter: _react["default"].PropTypes.bool,
  transitionEnterTimeout: _react["default"].PropTypes.number,
  transitionLeave: _react["default"].PropTypes.bool,
  transitionLeaveTimeout: _react["default"].PropTypes.number,
  transitionAppear: _react["default"].PropTypes.bool,
  transitionAppearTimeout: _react["default"].PropTypes.number
};
